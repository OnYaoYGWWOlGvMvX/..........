...
local _Misc = Tabs.Misc do
  ...
  _Misc:AddToggle({"Auto Aura [ฮาคิ]", true, function(Value) Settings.AutoHaki = Value end, "Auto Haki"})
  _Misc:AddToggle({"Auto Attack [โจมตี]", true, function(Value) Settings.AutoClick = Value end, "Auto Attack"})
  _Misc:AddToggle({"Bring Mobs [ดึงม็อบในระยะ]", true, function(Value) Settings.BringMobs = Value end, "Bring Mobs"})
