...
local DestroySquiddles = Tabs.Visuals:AddToggle("DestroySquiddles", { Title = "(Remove Squiddles)", Default = true })
local DestroyMonsterLocker = Tabs.Visuals:AddToggle("DestroyMonsterLocker", { Title = "(Remove MonsterLocker)", Default = true })
